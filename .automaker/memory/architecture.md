...
- **Trade-offs:** Simple portable distribution of templates (just git clone) vs. requires scaffolding step to process tokens after copying; can't use in CI/CD without extra step
...
#### [Pattern] Test-file exclusion (using grep -v '.test.|.spec.|**tests**') in dead code detection is essential for correctly identifying production-unused code that may still have test coverage (2026-03-17)
