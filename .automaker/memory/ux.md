...
- **Why this works:** Users need both _what to do next_ (features/tasks) and _how things work_ (context/reference). Features drive action; context reduces cognitive load when learning structure.
