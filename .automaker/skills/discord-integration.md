...
emoji: 💬
description: Discord bot integration patterns. Use when setting up Discord notifications, wiring channel routing, or debugging Discord bot login and MCP timeouts. Trigger on "Discord", "channel ID", "Discord bot", "message routing", or "Discord timeout".
metadata:
  author: agent
...
Channel IDs are configured per-instance via environment variables (DISCORD*CHANNEL*\*) or UserProfile settings. Check your project's .env or settings for current values.
