...
- **NEVER restart the dev server yourself** — coordinate with the operator
...
- **NEVER** deploy without verifying CI ran — direct commits to main bypass format/test checks. One format violation on main blocks every PR until fixed.
