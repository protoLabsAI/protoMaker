...
**Core principle:** "One effort, many surfaces." Content generation is automated — Cindi writes, Jon strategizes, schedulers distribute. Operator engages.
...
- Marketing speak that doesn't match direct, pragmatic voice
...
2. **"Orchestration beats implementation"** — Operator designs, agents build
...
- **NEVER** say the operator "coded", "implemented", "programmed", or "developed" anything — they architect and orchestrate. AI agents implement. This distinction IS the brand.
