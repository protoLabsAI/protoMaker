...
We take the security of Automaker seriously. If you discover a security vulnerability, please report it responsibly by following the process below.
...
- **Environment:** Version of Automaker affected, operating system, etc.
...
- **Limit repository access** - Only grant Automaker access to repositories you trust it to modify
- **Use worktrees in production carefully** - Understand the implications of automated git operations

## Bounty Program

We currently **do not offer a bug bounty program**. However, we deeply appreciate security researchers who help keep Automaker secure, and we will publicly acknowledge your contribution in:
...
- Watch the [GitHub repository](https://github.com/proto-labs-ai/automaker) for release notifications
- Join our [Discord server](https://discord.gg/jjem7aEDKU) for announcements
- Check the [release notes](https://github.com/proto-labs-ai/automaker/releases) regularly
...
Thank you for helping keep Automaker and its users safe!
