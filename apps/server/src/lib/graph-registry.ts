...
const GRAPH_REGISTRY: GraphDefinition[] = [
  ...
  },
  {
    ...
    nodes: [
      { id: 'planning', type: 'processor', description: 'Create execution plan' },
      { id: 'fan_out', type: 'fanout', description: 'Fan out to research and analysis workers' },
      {
        id: 'research_delegate',
        type: 'processor',
        description: 'Execute research task via subgraph',
      },
      {
        id: 'analyze_delegate',
        type: 'processor',
        description: 'Execute analysis task via subgraph',
      },
      { id: 'sequential_analysis', type: 'fanout', description: 'Sequential analysis fan-out' },
      { id: 'aggregation', type: 'aggregate', description: 'Aggregate results' },
    ],
    edges: [
      { from: 'planning', to: 'fan_out', condition: 'parallel or sequential' },
      { from: 'fan_out', to: 'research_delegate' },
      { from: 'fan_out', to: 'analyze_delegate' },
      { from: 'research_delegate', to: 'aggregation', condition: 'parallel' },
      { from: 'research_delegate', to: 'sequential_analysis', condition: 'sequential' },
      { from: 'sequential_analysis', to: 'analyze_delegate' },
      { from: 'analyze_delegate', to: 'aggregation' },
  ...
  },
  {
    ...
    edges: [
      ...
      { from: 'check_hitl', to: 'human_review', condition: 'hitl required' },
      { from: 'check_hitl', to: 'done', condition: 'no hitl' },
  ...
  },
  {
    ...
    edges: [
      ...
      { from: 'hitl_planning', to: 'done', condition: 'done' },
      { from: 'hitl_research', to: 'done', condition: 'done' },
      { from: 'hitl_prd', to: 'done', condition: 'done' },
      { from: 'create_issues', to: 'done' },
      { from: 'done', to: 'END' },
    ],
    entryPoint: 'research',
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'research_hitl', type: 'hitl', description: 'Research HITL checkpoint' },
      {
        id: 'increment_research_retry',
        type: 'processor',
        description: 'Increment research retry counter',
      },
      ...
      { id: 'outline_hitl', type: 'hitl', description: 'Outline HITL checkpoint' },
      {
        id: 'increment_outline_retry',
        type: 'processor',
        description: 'Increment outline retry counter',
      },
      ...
      { id: 'final_review_hitl', type: 'hitl', description: 'Final review HITL checkpoint' },
      {
        id: 'increment_final_retry',
        type: 'processor',
        description: 'Increment final retry counter',
      },
    ...
    edges: [
      ...
      { from: 'research_review', to: 'research_hitl' },
      { from: 'research_hitl', to: 'generate_outline', condition: 'approved' },
      { from: 'research_hitl', to: 'increment_research_retry', condition: 'revise' },
      { from: 'research_hitl', to: 'complete', condition: 'failed' },
      { from: 'increment_research_retry', to: 'generate_queries' },
      { from: 'generate_outline', to: 'outline_review' },
      { from: 'outline_review', to: 'outline_hitl' },
      { from: 'outline_hitl', to: 'fan_out_generation', condition: 'approved' },
      { from: 'outline_hitl', to: 'increment_outline_retry', condition: 'revise' },
      { from: 'outline_hitl', to: 'complete', condition: 'failed' },
      { from: 'increment_outline_retry', to: 'generate_outline' },
      ...
      { from: 'final_content_review', to: 'final_review_hitl' },
      { from: 'final_review_hitl', to: 'fan_out_output', condition: 'approved' },
      { from: 'final_review_hitl', to: 'increment_final_retry', condition: 'revise' },
      { from: 'final_review_hitl', to: 'complete', condition: 'failed' },
      { from: 'increment_final_retry', to: 'fan_out_generation' },
  ...
  },
  {
    ...
    name: 'Interrupt Loop',
    description:
      'Basic loop pattern with interrupt control. Note: This is a conceptual pattern demonstrating loop+interrupt primitives, not a production graph implementation.',
    topology: 'loop',
    nodes: [
