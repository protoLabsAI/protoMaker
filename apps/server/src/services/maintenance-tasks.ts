...
// autoMergeEligiblePRs, checkPRBehindStatus, sendDiscordConflictAlert,
// localRebaseAndPush, tryAutoResolveConflicts, autoRebaseStalePRs
// — all removed. Lead Engineer MERGE/REVIEW phases handle these.

/**
 * Scan worktrees for crash recovery opportunities.
 *
 * Runs non-blocking after server initialization to detect and recover
