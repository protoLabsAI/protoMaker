 ...
 *
 * Uploads the key prompt templates from @protolabsai/prompts to Langfuse,
...
import { DEFAULT_PROMPTS } from '@protolabsai/prompts';
    ...
    try {
      ...
      const result = await langfuse.createPrompt({
        ...
        commitMessage: force
          ...
          : 'Initial baseline from @protolabsai/prompts defaults',
      });
