...
> **Brand visual identity** — For the canonical color palette, typography, and component specs as they appear on the landing page and marketing properties, see [`design-system.md`](./design-system.md). This document covers the _implementation_ of those design decisions in the UI app's OKLch token system.
