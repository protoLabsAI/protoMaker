...
5. **Verify position in dependency chain** - Check the hierarchy diagram above and ensure your package only depends on packages at the same or lower level.
...
- [Creating MCP Tools](./creating-mcp-tools.md) - Build custom MCP tools for agents
