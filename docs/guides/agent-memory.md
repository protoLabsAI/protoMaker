...
See [Knowledge Hive](../reference/knowledge-hive.md#api-endpoints) for full API documentation.
...
- **[Knowledge Hive](../reference/knowledge-hive.md)** — Full architecture overview
