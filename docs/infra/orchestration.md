...
| `POST /api/projects/delete`          | Delete project and files   |
...
Group related features under milestones/epics for cleaner organization and parallel development.
...
Structure your PRDs with Situation, Problem, Approach, Results, and Constraints for clear communication.

## Learn More

- [MCP Tools Reference](../integrations/mcp-tools-reference.md) - All orchestration tools
- [Self-Hosting Deployment](../self-hosting/deployment.md) - Production deployment
