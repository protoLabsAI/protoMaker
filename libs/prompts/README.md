...
```bash
npm install @protolabsai/prompts
```
...
```typescript
import { getSystemPrompt } from '@protolabsai/prompts';
...
```typescript
import { getExamples } from '@protolabsai/prompts';
...
```typescript
import { buildUserPrompt } from '@protolabsai/prompts';
...
```typescript
import { isValidEnhancementMode } from '@protolabsai/prompts';
...
```typescript
import { getAvailableEnhancementModes } from '@protolabsai/prompts';
...
```typescript
import { isValidEnhancementMode, getAvailableEnhancementModes } from '@protolabsai/prompts';
...
```typescript
import { getSystemPrompt, buildUserPrompt, getExamples } from '@protolabsai/prompts';
...
- `@protolabsai/types` - Type definitions for EnhancementMode and EnhancementExample

## Used By

- `@protolabsai/server` - Enhancement API routes
