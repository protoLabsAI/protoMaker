...
/**
 * Customer context for framing a feature's target audience and expected benefit.
 */
export interface CustomerContext {
  /** Who this feature is for (user segment, persona, or role) */
  who: string;
  /** The problem or pain point being addressed */
  problem: string;
  /** The expected benefit or outcome for the customer */
...
export interface Feature {
   ...
   * Generated by PM Agent during PRD creation.
   */
  successCriteria?: string[];

  /**
   * Conditions that should trigger a stop or pivot on this feature.
   * If any condition is met during execution, the feature should escalate.
   * Generated by PM Agent during PRD creation.
   */
