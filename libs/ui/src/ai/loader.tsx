 ...
 *
 * Replaces/upgrades MessageProgressIndicator in chat-message.tsx.
 * Renders an animated dot-pulse loading indicator with an optional step count.
 *
 * Usage:
 *   <AILoader /> — just the dots
 *   <AILoader stepCount={3} /> — "Step 3" label beside the dots
 *   <AILoader stepCount={3} label="Thinking" /> — custom label text
 */
