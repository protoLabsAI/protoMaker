      ...
      {Array.from({ length: 20 }).map((_, i) => (
        <div key={i} className="mb-4 pb-4 border-b last:border-0">
          ...
          <p className="text-sm text-muted-foreground">
            This is an update about the project progress and recent changes that have been
      ...
      <div className="p-4 space-y-4">
        {Array.from({ length: 12 }).map((_, i) => (
          <div key={i} className="rounded-lg border p-4 space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              This is some content for card number {i + 1}. It demonstrates how cards can
              be scrolled within the scroll area.
            </p>
