...
describe('Fixture Validation', () => {
  const fixtures = [
    ...
    { name: 'monorepo-pnpm', expectedFiles: ['package.json', 'pnpm-workspace.yaml', 'pnpm-lock.yaml'] },
    { name: 'typescript-project', expectedFiles: ['package.json', 'tsconfig.json', 'src/index.ts', 'package-lock.json'] },
    { name: 'nextjs-app', expectedFiles: ['package.json', 'next.config.js', 'app/page.tsx', 'package-lock.json'] },
  ];
