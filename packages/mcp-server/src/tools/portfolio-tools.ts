/**
 * Cross-Repository Portfolio Dependency Tools
 *
 * Tools for tracking, flagging, and resolving dependencies across multiple
 * Automaker server instances (cross-repo dependencies).
 */
